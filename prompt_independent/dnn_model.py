...
class DNNModel(Classifier):
    def __init__(self, hidden_dim, dense_dim, weight, max_words, opt="adam", **kwargs):
        ...
        def model_essay(self):
            ...
            bi_lstm_layer = Bidirectional(
                LSTM(units=self.embedding_dim, output_dim=self.hidden_dim, return_sequences=False),
                merge_mode='concat'
            )(embedding_layer)
